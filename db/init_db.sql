...
WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT unique_game_record UNIQUE
(game_id)
);

-- Indexes for performance
CREATE INDEX
IF NOT EXISTS idx_score_user_id ON score
(user_id);
CREATE INDEX
IF NOT EXISTS idx_score_game_id ON score
(game_id);
CREATE INDEX
IF NOT EXISTS idx_global_record_game_id ON global_record
(game_id);
